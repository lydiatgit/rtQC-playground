...
gui_data.pb_docs = uicontrol('Parent', gui_data.panel_main,...
    ...
    'String', 'Readthedocs', ...
    'Units', 'Normalized',...
    'Position', [0.3 0.02 0.2 0.1],...
    'CallBack', @linkToDocs, ...
    'UserData', 0,...
    'fontweight', 'bold',...
    'fontsize', gui_data.button_font_size);
gui_data.pb_mode = uicontrol('Parent', gui_data.panel_main,...
    'Style', 'push',...
    'String', gui_data.mode_string, ...
    'Units', 'Normalized',...
    'Position', [0.5 0.02 0.2 0.1],...
    'CallBack', @changeMode, ...
    'UserData', 0,...
    'fontweight', 'bold',...
    'fontsize', gui_data.button_font_size);
...
gui_data.txt_selectData = uicontrol('Parent', gui_data.panel_preproc,...
    ...
    'HorizontalAlignment', 'left',...
    'Visible', gui_data.demo_visibility,...
    'fontsize', gui_data.small_font_size);
...
gui_data.pb_get_physio_batch = uicontrol('Parent', gui_data.panel_rtsummary,...
    'Style', 'push',...
    'String', 'Get physio batch', ...
    'Units', 'Normalized',...
    'Position', [0.8 0.305 0.1 0.225],...
    'CallBack', @physioBatch, ...
    'UserData', 0,...
    'fontsize', gui_data.button_font_size);
gui_data.popup_setVendor = uicontrol('Parent', gui_data.panel_rtsummary,...
    'Style', 'popup',...
    'String', {'BIDS','Philips','Biopac_Txt','GE','Siemens','Siemens_HCP','Siemens_Tics'},...
    'Units', 'Normalized',...
    'Position', [0.91 0.303 0.07 0.125],... % [0.06 0 0.22 0.1],... % 
    'Value', 1,...
    'Callback', @setVendor);
gui_data.txt_setVendor = uicontrol('Parent', gui_data.panel_rtsummary,...
    'Style','text',...
    'String','Vendor (for physio):',...
    'Units', 'Normalized',...
    'Position',[0.91 0.44 0.07 0.09],...
    'HorizontalAlignment', 'left',... 
    'fontsize', gui_data.small_font_size);
